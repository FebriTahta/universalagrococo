            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Image Menu</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card-body col-xl-6">
                    ...
                    <div class="modal-body">
                        <form id="formsubmit1" class="was-validated" enctype="multipart/form-data" method="post">@csrf
                            <input type="hidden" name="id" value="{{$menu_product->id}}">
                            <div class="p-4 border rounded">
                                <div class="mb-3">
                                    <label for="validationServer01" class="form-label">JUDUL</label>
                                    <input value="{{$menu_product->judul}}" type="text" name="judul" class="form-control" placeholder="-" required>
                                    <div class="invalid-feedback">harus diisi</div>
                                </div>
                                <div class="mb-3">
                                    <label for="validationServer01" class="form-label">SUB JUDUL</label>
                                    <input value="{{$menu_product->subjudul}}" type="text" name="subjudul" class="form-control" placeholder="-" required>
                                    <div class="invalid-feedback">harus diisi</div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="preview text-right">
                                        <img src="{{asset('be_menu/'.$menu_product->bg)}}" width="350" height="200" id="preview" class="img-thumbnail"><br>
                ...
                <div class="card-body col-xl-6">
                    ...
                    <div class="modal-body">
                        <form id="formsubmit2" class="was-validated" enctype="multipart/form-data" method="post">@csrf
                            <input type="hidden" name="id" value="{{$menu_contact->id}}">
                            <div class="p-4 border rounded">
                                <div class="mb-3">
                                    <label for="validationServer01" class="form-label">JUDUL</label>
                                    <input value="{{$menu_contact->judul}}" type="text" name="judul" class="form-control" placeholder="-" required>
                                    <div class="invalid-feedback">harus diisi</div>
                                </div>
                                <div class="mb-3">
                                    <label for="validationServer01" class="form-label">SUB JUDUL</label>
                                    <input value="{{$menu_contact->subjudul}}" type="text" name="subjudul" class="form-control" placeholder="-" required>
                                    <div class="invalid-feedback">harus diisi</div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="invalid-feedback">harus diisi</div><br>
                                    <div class="preview text-right">
                                        <img src="{{asset('be_menu/'.$menu_contact->bg)}}" width="350" height="200" id="preview2" class="img-thumbnail"><br>
                                        <small>1400px x 800px</small>
                                    </div>
                                </div>
                ...
                <div class="card-body col-xl-6">
                    ...
                    <div class="modal-body">
                        <form id="formsubmit3" class="was-validated" enctype="multipart/form-data" method="post">@csrf
                            <input type="hidden" name="id" value="{{$menu_profile->id}}">
                            <div class="p-4 border rounded">
                                <div class="mb-3">
                                    <label for="validationServer01" class="form-label">JUDUL</label>
                                    <input value="{{$menu_profile->judul}}" type="text" name="judul" class="form-control" placeholder="-" required>
                                    <div class="invalid-feedback">harus diisi</div>
                                </div>
                                <div class="mb-3">
                                    <label for="validationServer01" class="form-label">SUB JUDUL</label>
                                    <input value="{{$menu_profile->subjudul}}" type="text" name="subjudul" class="form-control" placeholder="-" required>
                                    <div class="invalid-feedback">harus diisi</div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="invalid-feedback">harus diisi</div><br>
                                    <div class="preview text-right">
                                        <img src="{{asset('be_menu/'.$menu_profile->bg)}}" width="350" height="200" id="preview3" class="img-thumbnail"><br>
                                        <small>1400px x 800px</small>
                                    </div>
                                </div>
