...
<div class="col-md-12">
<div class="mb-50">
                  <h2 class="section-title">BEST <span class="bold">PRODUCT</span></h2>
                </div>
            </div>
            ...
            <ul class="port-grid port-grid-3 port-grid-gut clearfix" id="items-grid">
              ...
              <li class="port-item mix">
                ...
                <div class="port-overlay-cont">
                    ...
                    <div class="port-btn-cont">
                      <a href="{{asset('assets/images/portfolio/projects-5.jp')}}g" class="lightbox mr-20" ><div aria-hidden="true" class="icon_search"></div></a>
              ...
              <li class="port-item mix">
                ...
                <div class="port-overlay-cont">
                    ...
                    <div class="port-btn-cont">
                      <a href="images/portfolio/projects-6.jpg" class="lightbox mr-20" ><div aria-hidden="true" class="icon_search"></div></a>
                      <a href="portfolio-single1.html"><div aria-hidden="true" class="icon_link"></div></a>
                    </div>
              ...
              <li class="port-item mix">
                <a href="portfolio-single1.html">
                  <div class="port-img-overlay">
                    <img class="port-main-img" src="{{asset('assets/images/portfolio/projects-7.jpg')}}" alt="img" >
                  </div>
                </a>
                <div class="port-overlay-cont">
              ...
              <li class="port-item mix">
                <a href="portfolio-single1.html">
                  <div class="port-img-overlay">
                    <img class="port-main-img" src="{{asset('assets/images/portfolio/projects-4.jpg')}}" alt="img" >
                  </div>
                </a>
                <div class="port-overlay-cont">
                    ...
                    <div class="port-btn-cont">
                      <a href="{{asset('assets/images/portfolio/projects-4.jpg')}}" class="lightbox mr-20" ><div aria-hidden="true" class="icon_search"></div></a>
                      <a href="portfolio-single1.html"><div aria-hidden="true" class="icon_link"></div></a>
                    </div>
                ...
                <li>
                    <div class="container" style="text-decoration-color: black">
                        <div class="sixteen columns contain">
                            ...
                            <img style="max-width: 300px" src="{{asset('be_product/'.$item->img)}}" class="item" alt="slide-item"  data-topimage="0"/>
                        </div>
                    </div><!-- End Container -->
                </li><!-- End item -->
                @endforeach
...
<div class="post-prev-title">
  <h3><a href="#" style="text-transform: uppercase">Cocofiber</a></h3>
</div>
  
<div class="post-prev-info">
  JULE 10<span class="slash-divider"></span><a href="https://1.envato.market/a1gQR"></a>
</div>
...
<div class="post-prev-more-cont clearfix">
  ...
  <div class="right" >
    <a href="##comments" class="post-prev-count"><span aria-hidden="true" class="icon_comment_alt"></span><span class="icon-count">21</span></a>
...
<div class="post-prev-img">
  <a href="#"><img src="{{asset('assets/images/blog/post-prev-2.jpg')}}" alt="img"></a>
</div>
  
<div class="post-prev-title">
  <h3><a href="#" style="text-transform: uppercase">Charcoal Briquette</a></h3>
</div>
  
<div class="post-prev-info">
  MAY 11<span class="slash-divider"></span><a href="https://1.envato.market/a1gQR"></a>
</div>
...
<div class="post-prev-img">
  <a href="#"><img src="{{asset('assets/images/blog/post-prev-3.jpg')}}" alt="img"></a>
</div>
  
<div class="post-prev-title">
  <h3><a href="#" style="text-transform: uppercase">Cocopeat</a></h3>
</div>
  
<div class="post-prev-info">
  DECEMBER 21<span class="slash-divider"></span><a href="https://1.envato.market/a1gQR"></a>
</div>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3957.407620157608!2d112.74823310265508!3d-7.308019703658126!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7fba78a3b4027%3A0x9c42c5ff58de32d2!2sJl.%20Sidosermo%20I%20No.8a%2C%20Sidosermo%2C%20Kec.%20Wonocolo%2C%20Kota%20SBY%2C%20Jawa%20Timur%2060239!5e0!3m2!1sid!2sid!4v1636277246273!5m2!1sid!2sid" width="100%" height="600" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
</div>
</div>
