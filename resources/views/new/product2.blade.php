...
<body>
    ...
    <![endif]-->
                        ...
                        <div class="col-md-4">
                            <div class="breadcrumbs">
                                <a href="/">Home</a><span class="slash-divider">/</span><span
                                    class="bread-current">ALL PRODUCTS</span>
                            </div>
                        </div>
            ...
            @foreach ($data_product as $key => $item)
                ...
                @if ($key % 2 == 0)
                    <!-- ADS 2 -->
                    <div class="page-section" id="{{$item->slug}}">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-6  ">
                                    <div class="fes2-main-text-cont">
                                        <div class="title-fs-45" style="text-transform: uppercase">
                                            COCONUT<br>
                                            <span class="bold"
                                                style="font-size: 28px; margin-top: 20px">{{ $item->name }}</span>
                                        </div>
                                        <div class="line-3-100"></div>
                                        <div class="fes2-text-cont">{{substr($item->deskripsi,0,100).' .....'}}</div>
                                        <div class="mt-30">
                                            <a class="button medium thin hover-dark mb-10"
                                                style="width: 180px; text-align: center" href="/coconut-product/{{$item->slug}}">SEE DETAIL</a>
                                            <a class="button medium thin hover-dark"
                                                style="width: 180px; text-align: center"
                                                href="{{ $data_contact->whatsapp }}">CONTACT US</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 wow fadeInRight">
                                    ...
                                    <div class="ads-img-cont">
                                        <img src="{{ asset('be_product/' . $item->img) }}" alt="img">
                                    </div>
